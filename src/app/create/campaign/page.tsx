...
export default function CreateCampaign() {
  ...
  return (
    <WalkthroughProvider walkthroughKey="campaign-generation">
      <div className="min-h-screen bg-[#1a1f2e] text-white">
        ...
        <div className="p-4 sm:p-8">
          <div className="w-full max-w-[1800px] mx-auto">
            ...
            <div className="campaign-walkthrough-welcome mb-4 relative z-10">
              <h1 className="text-2xl font-bold mb-2">Campaign Manager</h1>
              <p className="text-gray-400">Create and manage your tabletop RPG campaigns</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-4 lg:gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 max-h-[200px] lg:max-h-none overflow-y-auto lg:overflow-visible campaigns-list">
        ...
        {/* Walkthrough Steps */}
        <WalkthroughSteps steps={campaignWalkthroughSteps} />
